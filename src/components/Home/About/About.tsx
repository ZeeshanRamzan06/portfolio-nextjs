...
>
  ...
  <div className="grid grid-cols-1 md:grid-cols-[1fr_4fr] gap-6">
    ...
    <div className="hidden md:block relative">
      <div className="absolute left-1/2 h-full w-0.5 bg-blue-500"></div>
    </div>
    ...
    <div className="space-y-10">
      {/* Experience Section */}
      <div>
        <h2 className="text-3xl font-bold text-blue-700 mb-6">My Experience</h2>
        <div className="space-y-6">
          {/* Experience Item 1 */}
          <div className="relative flex flex-col gap-2 p-6 bg-white rounded-lg shadow-lg border border-gray-200 dark:bg-gray-800 dark:border-gray-600">
            <h3 className="font-bold text-xl text-blue-700 dark:text-white">
              Full Stack Web Developer
            </h3>
            <p className="text-gray-600 dark:text-gray-400">ITSOLERA </p>
            <p className="text-gray-500 dark:text-gray-500">August 2024</p>
          ...
          <div className="relative flex flex-col gap-2 p-6 bg-white rounded-lg shadow-lg border border-gray-200 dark:bg-gray-800 dark:border-gray-600">
            ...
            <p className="text-gray-500 dark:text-gray-500">January 2024</p>
          </div>
        </div>
      </div>
      ...
      {/* Education Section */}
      <div>
        <h2 className="text-3xl font-bold text-blue-700 mb-6">My Education</h2>
        <div className="space-y-6">
          {/* Education Item */}
          <div className="relative flex flex-col gap-2 p-6 bg-white rounded-lg shadow-lg border border-gray-200 dark:bg-gray-800 dark:border-gray-600">
            <h3 className="font-bold text-xl text-blue-700 dark:text-white">
            ...
            <ul className="list-disc text-gray-600 dark:text-gray-400 ml-6 mt-2">
              <li>
                Actively engaged in sports such as cricket and badminton for a
                healthy and active lifestyle.
              </li>
              <li>
                Contributed as a member of the software engineering community,
                participating in events and knowledge-sharing initiatives.
              </li>
            </ul>
          </div>
        </div>
