    ...
    <div className='dark:bg-[#262d42] bg-gray-400 rounded-lg  p-4 sm:p-10'>
        ...
        <form action="" className='mt-8 block w-full overflow-hidden'>
            <div className="flex flex-col md:flex-row items-center justify-center gap-4">
                <input type="text" placeholder='First Name'  className='flex-1 dark:bg-[#454E56] bg-gray-500 text-white dark:placeholder:text-white placeholder:text-gray-700
                px-6 py-3 rounded-md border-[1.5px] border-gray-200 border-opacity-15 outline-none w-full'/>
                <input type="text" placeholder='Last Name'  className='flex-1 dark:bg-[#454E56] bg-gray-500 dark:placeholder:text-white placeholder:text-gray-700
                px-6 py-3 rounded-md border-[1.5px] border-gray-200 border-opacity-15 outline-none w-full'/>
            </div>
            <div className="flex flex-col mt-5 md:flex-row items-center justify-center gap-4">
                <input type="email" placeholder='Email address'  className='flex-1 dark:bg-[#454E56] bg-gray-500 dark:placeholder:text-white placeholder:text-gray-700
                px-6 py-3 rounded-md border-[1.5px] border-gray-200 border-opacity-15 outline-none w-full'/>
                <input type="text" placeholder='Phone Number'  className='flex-1 dark:bg-[#454E56] bg-gray-500 dark:placeholder:text-white placeholder:text-gray-700
                px-6 py-3 rounded-md border-[1.5px] border-gray-200 border-opacity-15 outline-none w-full'/>
            </div>
            <div className="mt-5">
            <input type="text" placeholder='Enter Subject'  className='flex-1 dark:bg-[#454E56] bg-gray-500 dark:placeholder:text-white placeholder:text-gray-700
                px-6 py-3 rounded-md border-[1.5px] border-gray-200 border-opacity-15 outline-none w-full'/>
            </div>
            <textarea className='flex-1 mt-5 dark:bg-[#454E56] bg-gray-500 dark:placeholder:text-white placeholder:text-gray-700
